(* OASIS_START *)
(* DO NOT EDIT (digest: 48153daa3ed4e70614ccd991ecea95d6) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("expect_test_common", ["common"], []);
          ("expect_test_config", ["config"], []);
          ("expect_test_collector", ["collector"], []);
          ("expect_test_matcher", ["matcher"], []);
          ("ppx_expect_evaluator", ["evaluator"], []);
          ("ppx_expect_payload", ["expect_payload"], []);
          ("ppx_expect", ["src"], [])
       ];
     lib_c = [("expect_test_matcher", "matcher", [])];
     flags = [];
     includes =
       [
          ("src", ["common"; "expect_payload"]);
          ("matcher", ["common"]);
          ("expect_payload", ["common"]);
          ("evaluator", ["collector"; "common"; "matcher"]);
          ("collector", ["common"; "config"]);
          ("as_ppx", ["src"])
       ]
  }
  ;;
