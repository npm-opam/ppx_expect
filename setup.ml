(* OASIS_START *)
(* DO NOT EDIT (digest: f7593edc999f1c2be3166b9d97e511c3) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Expectation"; "File"; "Std"];
                      lib_pack = true;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Expect_test_config"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "expect_test_common";
                           InternalLibrary "expect_test_config";
               ...
               Object
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "expect_test_common";
                           InternalLibrary "expect_test_matcher"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      obj_modules = ["Ppx_expect_evaluator"];
                      obj_findlib_fullname = None
                   });
               Library
                 ({
                     cs_name = "ppx_expect_payload";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Ppx_expect_payload"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ppx_expect_payload";
                   ...
                   {
                      lib_modules =
                        ["Expect_extension"; "Expectation_lifter"; "Main"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\1286Der^\146fe\207\152\141+3\156\229";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
